...
export default function test() {
  ...
  let content5 = "development@pagestars.net"
  return (
    <>
      <Myheader />
      <Main values={[{ title: "Wie programmiert ihr Webseiten/Webapplikationen?", id: "1", content: content1 }, { title: "Was ist WordPress?", id: "2", content: content2 }, { title: "Ist WordPress sicher?", id: "3", content: content3 }, { title: "Was kostet eine Webseite?", id: "4", content: content4 }, { title: "Kontakt", id: "4", link: content5, content: "" },]} />
      <Footer />
    </>
